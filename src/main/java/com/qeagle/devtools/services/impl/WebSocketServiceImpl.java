...
import static com.qeagle.devtools.services.impl.utils.WebSocketUtils.isTyrusBufferOverflowCloseReason;
import static com.qeagle.devtools.services.utils.ConfigurationUtils.systemProperty;
...
public class WebSocketServiceImpl implements WebSocketService {
  public static final String WEB_SOCKET_CONTAINER_FACTORY_PROPERTY =
      "com.qeagle.devtools.services.config.webSocketContainerFactory";
   ...
   * com.qeagle.devtools.services.config.webSocketContainerProvider. The default value for this
    ...
    try {
      ...
      throw new RuntimeException(
          containerFactoryClassName
              + " does not implement com.qeagle.devtools.services.factory.WebSocketContainerFactory interface.");
